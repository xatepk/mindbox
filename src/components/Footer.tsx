...
export default function Footer(): JSX.Element {
  ...
  return (
    <footer className="tasks__item tasks__footer">
      ...
      <span className='tasks__filter'>{Pluralize('item', activeTasks.filter(t => !t.completed).length, true)}  left</span>
      <div>
        <FilterButton
      ...
      <button className='tasks__filter' onClick={() => dispath(clearCompleted(false))}>Clear Completed</button>
